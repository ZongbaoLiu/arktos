...
// ServiceExposesGetter has a method to return a ServiceExposeInterface.
// A group's client should implement this interface.
type ServiceExposesGetter interface {
	ServiceExposes(namespace string) ServiceExposeInterface
	ServiceExposesWithMultiTenancy(namespace string, tenant string) ServiceExposeInterface
}

// ServiceExposeInterface has methods to work with ServiceExpose resources.
type ServiceExposeInterface interface {
	...
	List(opts metav1.ListOptions) (*v1.ServiceExposeList, error)
	Watch(opts metav1.ListOptions) watch.AggregatedWatchInterface
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.ServiceExpose, err error)
	ServiceExposeExpansion
}

// serviceExposes implements ServiceExposeInterface
type serviceExposes struct {
...
// newServiceExposes returns a ServiceExposes
func newServiceExposes(c *CloudgatewayV1Client, namespace string) *serviceExposes {
	return newServiceExposesWithMultiTenancy(c, namespace, "system")
}

func newServiceExposesWithMultiTenancy(c *CloudgatewayV1Client, namespace string, tenant string) *serviceExposes {
...
func (c *serviceExposes) Get(name string, options metav1.GetOptions) (result *v1.ServiceExpose, err error) {
...
func (c *serviceExposes) List(opts metav1.ListOptions) (result *v1.ServiceExposeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.ServiceExposeList{}
	...
	if wgLen > 1 {
		...
		wg.Add(wgLen)
		results := make(map[int]*v1.ServiceExposeList)
		errs := make(map[int]error)
		for i, client := range c.clients {
			go func(c *serviceExposes, ci rest.Interface, opts metav1.ListOptions, lock *sync.Mutex, pos int, resultMap map[int]*v1.ServiceExposeList, errMap map[int]error) {
				r := &v1.ServiceExposeList{}
				err := ci.Get().
		...
		itemsMap := make(map[string]v1.ServiceExpose)
		for j := 0; j < wgLen; j++ {
...
// Watch returns a watch.Interface that watches the requested serviceExposes.
func (c *serviceExposes) Watch(opts metav1.ListOptions) watch.AggregatedWatchInterface {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *serviceExposes) Create(serviceExpose *v1.ServiceExpose) (result *v1.ServiceExpose, err error) {
	result = &v1.ServiceExpose{}
...
func (c *serviceExposes) Update(serviceExpose *v1.ServiceExpose) (result *v1.ServiceExpose, err error) {
	result = &v1.ServiceExpose{}
...
func (c *serviceExposes) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *serviceExposes) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *serviceExposes) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.ServiceExpose, err error) {
	result = &v1.ServiceExpose{}
