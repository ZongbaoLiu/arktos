...
import (
	...
	internalversionv1 "k8s.io/kubernetes/pkg/client/informers/internalversion/v1"
)
...
func NewFilteredSharedInformerFactoryWithMultiTenancy(client internalclientset.Interface, defaultResync time.Duration, namespace string, tweakListOptions internalinterfaces.TweakListOptionsFunc, tenant string) SharedInformerFactory {
...
type SharedInformerFactory interface {
	...
	Cloudgateway() internalversionv1.Interface
}

func (f *sharedInformerFactory) Cloudgateway() internalversionv1.Interface {
	return internalversionv1.NewWithMultiTenancy(f, f.namespace, f.tweakListOptions, f.tenant)
}
